    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">Rumah Sakit Pengin Sembuh</div>
            </a>
        ...
        <h1 align="center">Selamat Datang Di Rumah Sakit Pengin Sembuh</h1>
        </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Aldi Syafera - 312010008 | Universitas Pelita Bangsa 2022 |</span>
                    </div>
                </div>
            </footer>
</body>
