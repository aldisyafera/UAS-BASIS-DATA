...
if (isset($_POST['submit']))
{
	...
	$date =  $_POST['tgl_berobat'];
	$keluhan = $_POST['keluhan_pasien'];
	$diagnosa =  $_POST['hasil_diagnosa'];
	$plks =  $_POST['penatalaksanaan'];
	$sql = 'INSERT INTO berobat (id_berobat, id_pasien, id_dokter, tgl_berobat, keluhan_pasien, hasil_diagnosa, penatalaksanaan)';
		...
		<hr>
			<div class="main">
				<form method="post" action="berobat1_tambah.php" enctype="multipart/form-data">
					...
					<div class="input mb-3">
						<label for="tgl_berobat" class="col-sm-2 col-form-label">Tanggal Berobat</label>
